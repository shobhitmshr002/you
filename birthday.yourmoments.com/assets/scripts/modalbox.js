...
function startSlideShow(sourceURL, startID) {
	...
	var so = new SWFObject('http://www.yourmoments.com/assets/slideshows/photos/photosSlideShow.swf', 'yt-SlideShow', '512', '512', '7', '#000000');	//COMDIFFRES: (Remove absolute path of .net) absolute URL with yourtribute.net
